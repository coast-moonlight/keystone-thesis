...
\begin{itemize}
    \item \textbf{Keystone offers low-overhead enclaves} for CPU-bound workloads.
    \item \textbf{Memory-bound performance degrades} due to PMP overhead and context switching.
    \item \textbf{Scalability limited} by fixed PMP entries and misaligned region padding.
    \item \textbf{Performance can be improved} via alignment and workload partitioning strategies.
\end{itemize}
\end{frame}
